...
export const site = {
  ...
  phone: "+91 8006457447",
  socials: [
    { label: "GitHub", href: "https://github.com/mk6084518-design" },
    { label: "LinkedIn", href: "https://linkedin.com/in/manoj-kumar-138529392" },
    { label: "Email", href: "mailto:mk6084518@gmail.com" },
  ],
  stats: [
    { label: "Live projects", value: 2, suffix: "" },
    { label: "Core technologies", value: 12, suffix: "+" },
    { label: "APIs integrated", value: 4, suffix: "" },
  ],
  navLinks: [
